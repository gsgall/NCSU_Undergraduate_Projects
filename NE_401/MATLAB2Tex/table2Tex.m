function table2Tex(table, fileName, caption, format, permission, count)
%{ 
...
%} 
    ...
    if cols > len
        ...
        count = count + 1; 
        table2Tex( trim, fileName, caption, format, p, count );
        table2Tex( rest, fileName, caption, format, 'a', count );
    else 
